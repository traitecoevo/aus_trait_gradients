...
woody_field_traits_georef %>%
  ...
  dplyr::select(cell, taxon_name, trait_name, growth_form, woody_climber, elev, prec, srad, tavg , tmax, prec.cv, temp.cv, vpd,prec.wq, prec.dq,aridityIndexThornthwaite, climaticMoistureIndex, growingDegDays5, value, latitude, longitude) %>%
