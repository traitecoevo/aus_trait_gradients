...
```{r}
traits %>% ggplot(aes(Prec, value)) + geom_point() + scale_x_log10() + scale_y_log10() + facet_wrap(~trait_name)
```

```{r}
traits %>% ggplot(aes(Temp, value)) + geom_point() + scale_x_log10() + scale_y_log10() + facet_wrap(~trait_name)
```
