...
Compare resolution of Worldclim at highest resolution to CHELSA - has same 19 variables but at higher resolution which could be more useful for ecological applications - currently not available as TIF files from CHELSA are local and cannot be committed due to their size. climatedata::get_chelsa allows you to pull the tif files directly from the source but the get_chelsa was returning a connectivity error. 
